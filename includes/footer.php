  ...
  <div class="footer-inner">
    ...
    <div class="footer-column">
      ...
      <div class="footer-links">
        ...
        <a href="/pages/dining-zones/index.php" class="footer-link">Dining Zones</a>
        <a href="javascript:void(0)" class="footer-link">Reservations</a>
        <a href="javascript:void(0)" class="footer-link">Login</a>
      </div>
    </div>
