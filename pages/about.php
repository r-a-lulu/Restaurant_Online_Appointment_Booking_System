...
<section class="section-lg" style="background-color: var(--clr-muted);">
  <div class="container">
    <div class="story-grid">
      <div class="story-img">
        <img src="<?= $basePath ?>assets/images/team/about-chef.jpg" alt="Our Executive Chef at <?= e($siteName) ?>">
      </div>
      <div class="story-text">
        <p class="section-label">The Beginning</p>
        <h2>A Vision of Excellence</h2>
        <div class="story-paragraphs">
          <p>Founded in 2018, <?= e($siteName) ?> was born from a simple yet profound belief: that dining should be more than sustenance, it should be a pathway to human flourishing.</p>
  ...
  <div class="container">
    ...
    <div class="values-grid">
      <div class="value-card">
        <div class="value-card-icon"><span>I</span></div>
        <h3>Integrity</h3>
  ...
  <div class="container">
    ...
    <div class="team-grid">
      <div class="team-card">
        ...
        <p>Trained in the kitchens of Milan and Lyon, Chef Juson brings 20 years of culinary excellence to <?= e($siteName) ?>. His philosophy centers on honoring ingredients while pushing creative boundaries.</p>
      </div>
      <div class="team-card">
        <div class="team-member-header">
