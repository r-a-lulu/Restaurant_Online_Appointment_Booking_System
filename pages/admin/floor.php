...
try {
  ...
  // Fetch users for reservation dropdown
  $stmt = $pdo->prepare("SELECT user_id, first_name, last_name, email, phone FROM users WHERE role_id = (SELECT role_id FROM roles WHERE role_name = 'user') ORDER BY last_name, first_name");
  $stmt->execute();
  $users = $stmt->fetchAll() ?: [];
  $stmt->closeCursor();
  ...
  $stmt = $pdo->prepare("SELECT t.table_id, t.table_number, t.capacity, t.current_status, dz.zone_id, dz.zone_name,
  ...
  <main class="admin-main">
    <div class="admin-content">
      ...
      <header class="admin-header">
        <div class="admin-header-row" style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <div style="display:flex; gap:var(--space-3);">
            <button class="btn btn-outline" data-modal-open="reserveTableModal" style="display:flex; align-items:center; gap:var(--space-2);">
      ...
      <div class="admin-floor-wrap" style="margin-top:var(--space-6); overflow:visible;">
        <div id="floor-csrf-container" data-csrf="<?= e(csrf_token()) ?>" data-action-token="<?= e(action_token('admin_floor_update')) ?>" style="display:none"></div>
        ...
        ?>
        <div class="admin-panel <?= $first ? 'active' : '' ?>" data-panel="<?= e($key) ?>">
          ...
          <div class="admin-card" style="margin-top: var(--space-6);">
            ...
            <div class="admin-card-body">
              <div class="floor-grid-new">
                ...
                <div class="floor-tile-new floor-tile-new--<?= e($t['status']) ?>" data-status="<?= e($t['status']) ?>" data-table-id="<?= e((string)$t['table_id']) ?>" tabindex="0">
...
<div class="admin-modal" id="reserveTableModal">
  <div class="admin-modal-card" style="max-width:32rem;">
    ...
    <form class="admin-form" id="reserveTableForm" method="post" action="../../actions.php?action=admin_reserve_table">
      ...
      <!-- Guest Info (auto-filled or manual for walk-in) -->
      ...
      <div class="form-row" style="margin-bottom:var(--space-4);">
        <div class="form-group" style="flex:1;">
          ...
          <select class="form-select" id="reserveZone" name="zone_id" required>
        ...
        <div class="form-group" style="flex:1;">
          <label class="form-label">Table <span style="color:var(--clr-danger);">*</span></label>
          <select class="form-select" id="reserveTable" name="table_id" required disabled>
      ...
      <div class="form-group" style="margin-bottom:var(--space-6);">
        ...
        <select class="form-select" id="reserveSeating" name="seating_preference" style="width:100%;">
